...
public:
    ...
    void serializeStrings(const std::vector<std::string>& vec, std::string& outStr, std::vector<int>& lengths);
    std::vector<std::string> deserializeStrings(const std::string& inStr, const std::vector<int>& lengths);
    void mergeAllLocalGuesses(const std::vector<std::string>& local_guesses, std::vector<std::string>& guesses, MPI_Comm comm = MPI_COMM_WORLD);
};
